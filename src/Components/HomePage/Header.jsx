...
const Header = () => {
    return (
        <section className='w-10/12 mx-auto md:flex mt-6 lg:mt-14'>
            {/* left part of large device */}
            <div className='md:w-7/12 pt-4'>
                <h1 className='text-2xl lg:text-4xl font-extrabold text-black md:w-5/6 uppercase'>Discover,and collect digital art Nfts</h1>
                ...
                <div className='flex gap-6 mt-6'>
                    <div>
                        ...
                        <small className='text-neutral font-semibold'>Artwork</small>
                    </div>

                    <div>
                        <h1 className='text-3xl font-extrabold text-black mb-0'>12K+</h1>
                        <small className='text-neutral font-semibold'>Auction</small>
                    </div>

                    <div>
                        <h1 className='text-3xl font-extrabold text-black mb-0'>15K+</h1>
                        <small className='text-neutral font-semibold'>Artist</small>
                    </div>
                </div>
            </div>
